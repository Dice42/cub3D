...
//     draw_vertical_line(cube, projected_x, screen_center_y, screen_center_y + distance, 0x00FF00);
...
void minimap_rays(t_cub3d *cube, int i)
{
    ...
    // Calculate the height of the line to draw based on distance
    line_height = ( 64 * HEIGHT) / distance;
